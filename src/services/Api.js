...
const URL = {
  ...
  RADIOLOGY_BILLING:'/api/radiologyBilling',
   ...
   SEARCH_BY_PRESCRIPTION:'/api/search_by_prescriptionno',
   RADIOLOGY_TRANSACTIONS:'/api/radiologyTransactions',
   RADIOLOGY_BILLING:'/api/radiologyBilling',  RADIOLOGY_REPORT:'/api/radiologyReport',
  ...
  APPOINTMENT_SETUP_SHIFTS:'/api/appointmentsetupshift',
  APPOINTMENT_SETUP_SLOT_DOCTOR:'/api/appointmentsetupdoctor',
  APPOINTMENT_SETUP_SLOT_SHIFT:'/api/appointmentsetupshift',
...
ABHA_PHR_ADDRESS_SUGGESTION: '/abha_address_creation_by_mobile_abha_adress_suggestion',
...
function getPharmacyBillReport(timeDuration,fromAge,toAge, gender, collectedBy,paymentMode){
  console.log("timeDuration:",timeDuration)
...
function getBloodIssueReport(timeDuration, bloodCollectedBy,amountCollectedBy,bloodGroup,bloodDonor){
  console.log("timeDuration:", timeDuration);
...
function getComponentIssueReport(timeDuration, bloodCollectedBy,amountCollectedBy,bloodGroup,components){
  console.log("timeDuration:", timeDuration);
  console.log("bloodCollectedBy:", bloodCollectedBy);
  console.log("amountCollectedBy:", amountCollectedBy);
  console.log("bloodGroup:", bloodGroup);
...
function getTPADetails(timeDuration, doctor,tpa,caseId,chargeCategory,charge){
  console.log("timeDuration:", timeDuration);
  console.log("doctor:", doctor);
  console.log("tpa:", tpa);
...
function createPhrAddress(transactionId,phrAddress,password,alreadyExistedPHR){
  console.log(transactionId,phrAddress,password,'ddddddd');
  return http2.post(URL.ABHA_PHR_ADDRESS_CREATION,{transactionId,phrAddress,password,alreadyExistedPHR})
}
...
function initAbhaOtp(authMode,abhaAddress,purpose,type,typeId){
  return http2.post(URL.ABHA_M1_OTP,authMode,abhaAddress,purpose,type,typeId)
}
