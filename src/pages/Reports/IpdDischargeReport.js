...
//redux
const IpdDischargedreport = (props) => {
  ...
  const columnDefs = [
    ...
    { headerName: "Consutant", field: "name" },
    ...
    { headerName: "Total Admit Days", field: "admittedDays" },
  ];
  ...
  const handleSearch = async () => {
    const response = await api.getIpddDischarges(formData, toAge, fromAge);
    const { data } = response;
            ...
            <CardBody>
              ...
              <Row>
                ...
                <Col lg="3" sm="12">
                  ...
                  >
                    <option>select</option>
                    <option key="Death" value="1">
                      Death
                    </option>
                    <option key="Referral" value="2">
                      Referral
                    </option>
                    <option key="Normal" value="3">
                      Normal
                    </option>
                  </select>
                </Col>
...
export default withTranslation()(IpdDischargedreport);
