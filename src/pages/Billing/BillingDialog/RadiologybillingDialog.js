        ...
        >
          ...
          <div className="mt-3 d-flex justify-content-end">
            ...
            {/* <PatientPathologyDialog
              ...
              <OpdPatientDialog open={openDialog} handleClose={handleCloseDialog} setFetchData={setFetchData}/>
          </div>
        </DialogTitle>
              ...
              <Col lg="12">
                <Row>
                  <Col lg="4" md="4">
                    ...
                    <br />
                    <select style={{ width: "90%", height: "25px" }} value={data.test_name} id="test_name" onChange={e=>onChange(e)} >
                      <option>Select</option>
                      {testName &&
                testName.map((test) => (
                  ...
                  <Col lg="4" md="4">
                    ...
                    <input
                      placeholder=""
                      style={{ width: "90%", height: "25px" }} value={data.reporting_date} id="reporting_date" onChange={e=>onChange(e)}
                    ></input>
                  </Col>
                </Row>
                ...
                <Row>
                  ...
                  <Col lg="4" md="4">
                    ...
                    <input
                      placeholder="%"
                      style={{ width: "90%", height: "25px" }}  value={data.tax} id="tax" onChange={e=>onChange(e)}
                    ></input>
                  </Col>
                  <Col lg="4" md="4">
                    <label>Amount(₹)</label>
                ...
                <Row>
                  <Col lg="5">
                    ...
                    <textarea
                      maxLength="infinity"
                      style={{ width: "90%", height: "55px" }} value={data.note} id="note" onChange={e=>onChange(e)}
                    ></textarea>
                    <br />
                    <br />
                    <label>Referal Doctor</label>
                    <br />
                    <select style={{ width: '70%' }} value={data.name} id="name" onChange={e=>onChange(e)} >
                      <option>select</option>
                      {consdoctor &&
                consdoctor.map((doctor) => (
                  <option key={doctor.id} value={doctor.id}>
                    ...
                    <br />
                    <input style={{ width: '70%' }} value={data.doctor_name} id="doctor_name" onChange={e=>onChange(e)} ></input>
                  ...
                  >
                    ...
                    <Row className="ms-2">
                      ...
                      <Col lg="7">
                        <input
                          ...
                          placeholder="0"
                          value={data.total} id="total" onChange={e=>onChange(e)}
                        ></input>
                      </Col>
                    </Row>
                    <br />
                    <Row className="ms-2">
                      ...
                      <Col lg="7">
                        <input
                          ...
                          placeholder="0"
                          value={data.discount} id="discount" onChange={e=>onChange(e)}
                        ></input>
                      </Col>
                    </Row>
                    <br />
                    <Row className="ms-2">
                      ...
                      <Col lg="7">
                        <input
                          ...
                          placeholder="0"
                          value={data.tax} id="tax" onChange={e=>onChange(e)}
                        ></input>
                      </Col>
                    </Row>
                    <br />
                    ...
                    <Row>
                      <Col>
                        ...
                        <br />
                        <input style={{ width: "65%" }} value={data.amount} id="amount" onChange={e=>onChange(e) } ></input>
                      </Col>
                    </Row>
