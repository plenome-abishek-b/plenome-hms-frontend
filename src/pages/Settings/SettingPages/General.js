      ...
      <div className="page-content">
        <Row>
          <Col lg="12" className="">
            ...
            <div>
              <h4 className="ms-4">General Settings</h4>
            </div>
            ...
            <Container className="mt-2">
              <Row>
                ...
                <Col lg="4">
                  <input style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }} id="name" onChange={e => onChange(e)}></input>
                </Col>
                <Col lg="2">
                  <label>Hospital Code</label>
                </Col>
                <Col lg="4">
                  <input style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }}></input>
                </Col>
              </Row>
              <br />
              <Row>
                ...
                <Col lg="10">
                  <textarea style={{ width: "100%", height: '70px', border: '1px solid grey', borderRadius: '5px' }} id="address" onChange={e => onChange(e)} />
                </Col>
              </Row>
              <br />
              <Row>
                ...
                <Col lg="4">
                  <input style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }} id="phone" onChange={e => onChange(e)}></input>
                </Col>
                <Col lg="2">
                  <label>Email</label>
                </Col>
                <Col lg="4">
                  <input style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }} id="email" onChange={e => onChange(e)}></input>
                </Col>
              </Row>
              <br />
              ...
              <Row>
                ...
                <Col lg="4" className="mt-2">
                  <input id="languages" onChange={e => onChange(e)} style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }}></input>
                </Col>
                <Col lg="2">
              ...
              <Row>
                ...
                <Col lg="6" className="mt-3">
                  ...
                  <br />
                  <input type="date" style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }} id="date_format" onChange={e => onChange(e)}></input>
                </Col>
              ...
              <Row>
                ...
                <Col lg='4' className="mt-3">
                  <input id="start_month" onChange={e => onChange(e)} style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }}></input>
                </Col>
              </Row>
              <hr style={{ height: '0.1px' }} className="mt-4"></hr>
              <br />
              <Row>
                <h4>Currency</h4>
                <Col lg="2" className="mt-3">
                ...
                <Col lg="4" className="mt-3">
                  <select style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }} id="currency" onChange={e => onChange(e)}>
                ...
                <Col lg="4" className="mt-3">
                  <input style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }} id="currency_symbol" onChange={e => onChange(e)}></input>
                </Col>
              </Row>
              <br />
              <Row>
              ...
              <Row>
                ...
                <Col lg="10">
                  <br />
                  <input style={{ width: "100%", height: '30px', border: '1px solid grey', borderRadius: '5px' }} id="mobile_api_url" onChange={e => onChange(e)}></input>
                </Col>
              </Row>
              <br />
              <Row>
