            ...
            <CardBody>
              <Row>
                <Col lg="3">
                  ...
                  <input
                    placeholder=""
                    style={{ width: "100%", height: "30px",border: '1px solid grey', borderRadius: '8px' }}
                  ></input>
                </Col>
                <Col lg="3" md="12" sm="12">
                  <label>Role</label>
                  <br />
                  <select style={{ width: "100%", height: "30px",border: '1px solid grey', borderRadius: '8px' }}>
              ...
              <Row>
                <Col lg="3" md="12" sm="12">
                  ...
                  <br />
                  <input style={{ width: "100%", height: "30px",border: '1px solid grey', borderRadius: '8px' }}></input>
                </Col>
                <Col lg="3" md="12" sm="12">
              ...
              <Row>
                <Col lg="6" md="12" sm="12">
                  ...
                  <textarea
                    ...
                    style={{ width: "100%", height: "50px",border: '1px solid grey', borderRadius: '8px' }}
                  ></textarea>
                </Col>
                <Col lg="6" md="12" sm="12">
                          ...
                          <Row className="mt-3">
                            ...
                            <Row>
                              ...
                              <Col lg='4'>
                                ...
                                <br />
                                <input placeholder="Number of leaves" style={{ width: "100%", height: "30px",border: '1px solid grey', borderRadius: '8px' }}></input>
                              </Col>
                              <Col lg='4'>
