            ...
            <li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                  <Link to="/Patient_id_card">{props.t("Patient ID Card")}</Link>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul >
                  ...
                  <li>
                    <Link to="/opdbalancereport">{props.t("OPD Balance Report")}</Link>
                  </li>
                  <li>
                    <Link to="/ipdbalancereport">{props.t("IPD Balance Report")}</Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/payrollreport">
                      {props.t("Payroll Report")}
                    </Link>
                  </li>
                  <li>
                    <Link to="/birthreport">
                      {props.t("Birth Report")}
                    </Link>
                  </li>
                  <li>
                    <Link to="/deathreport">
                      {props.t("Death Report")}
                    </Link>
                  </li>
                  <li>
                    <Link to="/otreport">
                  ...
                  <li>
                    <Link to="/referralreport">
                      {props.t("Referral Report")}
                    </Link>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul style={{ marginLeft: "-30px" }}>
                  ...
                  <li>
                    <Link to="#" className="has-arrow">{props.t("Symptoms")}</Link>
                    <ul style={{marginLeft: '-30px'}}>
                      <li><Link to="/setup/symptomshead">{props.t("Symptoms Head")}</Link></li>
                      <li><Link to="/setup/symptomstype">{props.t("Symptoms Types")}</Link></li>
                    </ul>
                    </li>
                  <li>
                    <Link to="#" className="has-arrow">
                  ...
                  <li>
                    ...
                    <ul style={{ marginLeft: "-30px" }}>
                      ...
                      <li>
                        <Link to="/frontoffice-setup/source">{props.t("Source")}</Link>
                      </li>
                      <li>
                        <Link to="/frontoffice-setup/complain-type">{props.t("Complain Type")}</Link>
                      </li>
                      <li>
                        <Link to="/frontoffice-setup/appointment-priority">{props.t("Appointment Priority")}</Link>
                      </li>
                    </ul>
                  </li>
                  <li>
